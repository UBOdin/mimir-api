...
libraryDependencies ++= Seq(
  ...
  //GIS Support
  //Local
  "org.datasyslab"                %  "geospark"                  % "1.4.1" excludeAll(ExclusionRule(organization ="javax.servlet"), ExclusionRule(organization ="com.amazonaws")),
  "org.datasyslab"                %  "geospark-sql_3.0"          % "1.4.1" excludeAll(ExclusionRule(organization ="javax.servlet"), ExclusionRule(organization ="com.amazonaws"), ExclusionRule(organization ="org.datasyslab", name="sernetcdf")),
  "org.datasyslab"                %  "geospark-viz_3.0"          % "1.4.1" excludeAll(ExclusionRule(organization ="javax.servlet"), ExclusionRule(organization ="com.amazonaws"), ExclusionRule("org.apache.hadoop"), ExclusionRule("org.apache.http"), ExclusionRule(organization ="org.datasyslab", name="sernetcdf")),
